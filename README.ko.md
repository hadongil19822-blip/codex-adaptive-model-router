...
Codex Desktop에서 요청마다 **Luna·Terra·Sol과 사고 강도를 자동 선택**하는 로컬 오픈소스 라우터입니다. 분류 자체에는 모델을 호출하지 않아 토큰을 사용하지 않으며, 여러 작업을 메뉴 막대에서 함께 확인할 수 있습니다.
...
- 다음 턴 사전 예약은 Codex Desktop의 로컬 IPC를 사용하므로 앱 업데이트 후 호환성 확인이 필요할 수 있습니다.
